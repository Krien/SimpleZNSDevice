...
enum szd_status_code {
  ...
  SZD_SC_SPDK_ERROR_WRITE = 0x07,
  SZD_SC_SPDK_ERROR_READ = 0x08,
  SZD_SC_SPDK_ERROR_RESET = 0x09,
  SZD_SC_SPDK_ERROR_REPORT_ZONES = 0x0A,
  SZD_SC_SPDK_ERROR_ZCALLOC = 0x0B,
  SZD_SC_SPDK_ERROR_QPAIR = 0x0C,
  SZD_SC_SPDK_ERROR_FINISH = 0x0D,
  SZD_SC_SPDK_ERROR_POLLING = 0x0E,
  SZD_SC_UNKNOWN = 0x0F
};
